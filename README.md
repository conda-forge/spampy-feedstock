...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spampy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12080&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spampy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spampy` can be installed with:

```
conda install spampy
```

It is possible to list all of the versions of `spampy` available on your platform with:
